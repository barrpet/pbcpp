#ifndef PBCPP_ADJACENCY_ARRAY_HPP
#define PBCPP_ADJACENCY_ARRAY_HPP

#include "GraphBase.hpp"

namespace pbcpp { namespace Graph {
...
typedef adjacency_array AdjacencyArray;

} } //namespace pbcpp::Graph

#endif //PBCPP_ADJACENCY_ARRAY_HPP
